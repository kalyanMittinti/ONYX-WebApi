...
namespace Onyx.Common.Helpers
{
    public sealed class SQLHelper
    {
        ...
        private static void CreateParameters(SqlParameter[] parameters)
        {
            if (parameters != null)
            {
                _output = null;
        ...
        public static Boolean SQLHelper_ExecuteNonQuery(string Procedure_Name, SqlParameter[] parameters)
        {
            try
            {
                _result = false;
        ...
        public static Object SQLHelper_ExecuteScalar(string Procedure_Name, SqlParameter[] parameters)
        {
            try
            {
                _value = null;
        ...
        public static DataTable SQLHelper_ExecuteReader(string Procedure_Name, SqlParameter[] parameters)
        {
            DataTable _data = null;
            try
            {
